...
export const projectsData = [
  ...
  },
  {
    ...
    detailedDescription:
      "Developed a browser-based 3D marble game using Three.js and React Three Fiber, simulating realistic physics such as gravity, friction, and collision detection. Implemented interactive levels with dynamic obstacles, responsive controls, and optimized rendering for smooth performance across devices.",
    keyFeatures: [
